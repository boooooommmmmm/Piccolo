...
bool Pilot::PVulkanManager::initializeDescriptorPool()
{
    ...
    //pool_sizes[5].type            = VK_DESCRIPTOR_TYPE_INPUT_ATTACHMENT;//Sven modify: extend pool size
    //pool_sizes[5].descriptorCount = 4 + 1 + 1 + 2;//Sven modify: extend pool size
